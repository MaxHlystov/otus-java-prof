...
import ru.fmtk.khlystov.otus_java.lib.SensorDataBufferedWriterFake;
import ru.fmtk.khlystov.otus_java.services.SensorDataProcessingFlowImpl;
import ru.fmtk.khlystov.otus_java.services.FakeSensorDataGenerator;
import ru.fmtk.khlystov.otus_java.services.SensorsDataQueueChannel;
import ru.fmtk.khlystov.otus_java.services.SensorsDataServerImpl;
import ru.fmtk.khlystov.otus_java.services.processors.SensorDataProcessorBuffered;
import ru.fmtk.khlystov.otus_java.services.processors.SensorDataProcessorCommon;
import ru.fmtk.khlystov.otus_java.services.processors.SensorDataProcessorErrors;
import ru.fmtk.khlystov.otus_java.services.processors.SensorDataProcessorRoom;
